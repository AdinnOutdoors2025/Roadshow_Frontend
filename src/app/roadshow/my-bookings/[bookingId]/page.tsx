...
//                       onClick={() => void refreshLiveLocation()}
...
//                       <RefreshCw
//                         size={15}
//                         className={liveRefreshing ? "RST_Spin" : ""}
//                       />
//                       <span>{liveRefreshing ? "Refreshing" : "Refresh"}</span>
//                     </button>
                ...
                <div className="RST_DayTimelineTrack">
                  {dayRows.map((row, index) => (
                    <button
                      ...
                      className={
                        selectedDayIndex === index
                          ? "RST_DayTimelineItem RST_DayTimelineItem--active"
                          : "RST_DayTimelineItem"
                      }
                      onClick={() => setSelectedDayIndex(index)}
                    >
                      <span className={`RST_DayTimelineDot ${reportStatusClass(row.status)}`} />
                      <span className="RST_DayTimelineCopy">
                        <small>Day {String(index + 1).padStart(2, "0")}</small>
                        <strong>{formatDate(row.day)}</strong>
                        <em>{reportStatusLabel(row.status)}</em>
                      </span>
                    </button>
                  ))}
                </div>
                ...
                <div className="RST_DayDetail RST_DayDetail--wide">
                  ...
                  <div className="RST_ReportMetrics">
                    <div className="RST_ReportMetric RST_ReportMetric--blue">
                      ...
                      <span><small>Distance covered</small><strong>{Number(selectedDay.distanceCoveredKm || 0).toFixed(2)} km</strong></span>
                    </div>
                    <div className="RST_ReportMetric RST_ReportMetric--green">
