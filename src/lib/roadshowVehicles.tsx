...
// export const FALLBACK_VEHICLE_IMAGE = "/images/Truck_Image.jpg";
...
// const resolveVehicleImage = (value: any): string => {
...
// const getVehicleImages = (mediaFiles: any): string[] => {
//   const images = [
...
// const isRegistrationAvailable = (registration: any): boolean => {
//   if (registration?.activeStatus === false) return false;
...
//       const name = String(
//         group?.basicInfo?.vehicleName || "Roadshow Vehicle"
//       ).trim();

//       const matchedVehicleType =
//         vehicleTypes.find(
//           (type) => getObjectId(type) === vehicleTypeId
//         ) || null;
...
//           (pkg) =>
//             pkg?.isActive !== false &&
//             getObjectId(pkg?.vehicleType) === vehicleTypeId &&
//             normalizeModelName(pkg?.vehicleModel) ===
//               normalizeModelName(name)
//         ) || null;

//       const images = getVehicleImages(group?.mediaFiles || {});
...
//             group?.basicInfo?.vehicleType?.typeName ||
//             ""
//         ),
...
//         rate: Number(matchedPackage?.perDayRentalCost || 0),
//         rating: "4.3",
...
//         availableVehicles: registrationVehicles.filter(
...
//       packageResponse,
//     ] = await Promise.all([
//       fetch(`${baseUrl}/api/getNewVehicles`, {
//         cache: "no-store",
//       }),
//       fetch(`${baseUrl}/api/vehicle-types`, {
//         cache: "no-store",
//       }),
...
//     const vehicleGroups = Array.isArray(vehicleResult?.data)
//       ? vehicleResult.data
//       : [];

//     const vehicleTypes = Array.isArray(vehicleTypeResult?.data)
//       ? vehicleTypeResult.data
//       : [];

//     const packages = Array.isArray(packageResult?.data)
//       ? packageResult.data
//       : [];
// console.log('PACKAGES:', packageResult);
...
// export const fetchRoadshowVehicleById = async (
//   vehicleId: string
